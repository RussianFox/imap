...
bingAPIkey='AhqdYGprP-Gt7c7RAkSjRwaR71a94UYECWw7FlK06mZvGHZoZm1EjSh8Dp8jdLVW';

/* true for show hardware icons */
/* Значение true для показа иконок оборудования */
_imap.settings.show_icons = true;

/* true for use Google Search on map */
/* Значение true для использования адресного поиска Google */
